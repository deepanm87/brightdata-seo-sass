            ...
            {(seoReport?.keywords?.content_keywords || []).map(
              (keyword, index) => {
                const intentConfig = {
                  ...
                  navigational: {
                    bgClass: "bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:t0-emerald-950/30",
                  ...
                  transactional: {
                    bgClass: "bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-950/30 dark:to-violet-950/30",
                            ...
                            {keyword.evidence.map((evidence, evidenceIndex) => (
                              ...
                              >
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                  ...
                                  >
                                    {Math.round(evidence.relevance_score * 100)} % relevance
                                  </Badge>
                                </div>
                              </div>
                            ))}
          ...
          <div className="grid gap-4 sm:gap-6">
            {(seoReport?.keywords?.keyword_themes || []).map((theme, index) => {
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className={`p-2 rounded-full bg-white/80 dark:bg-black/20 ${themeConfig.iconClass} flex-shrink-0`}>
