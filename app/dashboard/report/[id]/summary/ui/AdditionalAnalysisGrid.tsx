        ...
        <Card className="border bg-gradient-to-br from-card to-card/95">
          <CardHeader className="pb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-2xl">Blacklink Sources</CardTitle>
                ...
                (source, index) => {
                  const sourceTypeConfig = {
                    educational_citations: {
                      ...
                      borderClass: "border-blue-600 dark:text-blue-800",
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-4">
                        <div className={`p-2 rounded-full bg-white/80 dark:bg-black/20 ${config.iconClass} flex-shrink-0`}>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            {source.evidence && source.evidence.length > 0 && (
                              ...
                              >
                                {Math.round(source.evidence[0].relevance_score * 100)} % relevance
                              </Badge>
                            )}
                          </div>
                        </div>
        ...
        <Card className="border bg-gradient-to-br from-card to-card/95">
          ...
          <CardContent>
            <div className="space-y-6">
              <div className="p-4 rounded-xl border bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-950/30 dark:to-cyan-950/30
              ...
              <div className="p-4 rounded-xl border bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 border-amber-200 dark:border-amber-800">
                ...
                <div className="grid gap-3 max-h-40 overfloy-y-auto">
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2">
                              <div className="w-12 h-2 bg-muted rounded-full">
                                <div 
                                  className="h-2 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full transition-allo duration-500"
