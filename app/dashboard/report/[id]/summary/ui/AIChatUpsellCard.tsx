...
export function AIChatUpsellCard() {
  return (
    <Card
      className="border-none shadow-2xl bg-gradient-to-br from-indigo-500/10 via-purple-500/8 to-pink-500/10 relative overflow-hidden group hover:shadow-indigo-500/20 transition-all duration-500"
    >
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Get instant, intelligent insights about your SEO report. Ask questions, discover opportunities, and receive personalized recommendations powered by advanced AI.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center gap-3 p-4 rounded-xl bg-white/50 dark:bg-white/5 border-indigo-100 dark:border-indigo-800/30">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              ...
              <Button
                variant="outline"
                asChild
                className="border-indigo-200 dark:border-indigo--800 hover:bg-indigo-50 dark:hover:bg-indigo-950 hover:border-indigo-300 dark:hover:border-indigo-700 transition-all duratin-300 px-8 py-6 text-base h-auto"
              >
              ...
              <div className="relative">
                <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-6 mb-4 border border-gray-100 dark:border-gray-800 max-w-sm ml-auto">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    &ldquo;Your page load speed is affecting SEO. I recommend optimizing images and enabling compression for a 40% improvement.&rdquo;
                  </p>
                </div>
